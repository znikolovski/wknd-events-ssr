...
require('./ExperienceFragmentPage.css');
...
class ExperienceFragmentPage extends Page {
  get containerProps() {
    let attrs = super.containerProps;
    attrs.className =
      (attrs.className || '') + ' xfpage ' + (this.props.cssClassNames || '');
    return attrs;
  }
}

export default MapTo('wknd-spa-react/components/xfpage')(
  withComponentMappingContext(withRoute(ExperienceFragmentPage))
);

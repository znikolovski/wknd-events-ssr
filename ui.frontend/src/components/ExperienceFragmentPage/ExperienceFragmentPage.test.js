...
import ExperienceFragmentPage from './ExperienceFragmentPage';

describe('ExperienceFragmentPage ->', () => {
  const ROOT_NODE_CLASS_NAME = 'route-node';
  const PAGE_CLASS_NAME = 'xfpage';
  ...
  it('should render the page component with no parameter', () => {
    ...
    ReactDOM.render(<ExperienceFragmentPage />, rootNode);
  ...
  it('should render the page component with no parameter', () => {
    ...
    ReactDOM.render(<ExperienceFragmentPage cssClassNames={EXTRA_CLASS_NAMES} />, rootNode);
